...
export function Preferences() {
  ...
  return (
    <><Box
      ...
      >
          <div style={{ backgroundColor: 'lightgrey', fontWeight: 'bold', fontSize: '20px', textAlign: 'center', border: '3px solid #000000' }}>{t('CourseList')}</div>
          <FixedSizeList
              height={400}
              width={360}
              itemSize={46}
      ...
      >
              <div style={{ backgroundColor: 'lightgrey', fontWeight: 'bold', fontSize: '20px', textAlign: 'center', border: '3px solid #000000' }}>{t('PreferredCourses')}</div>
              <FixedSizeList
                  height={400}
                  width={360}
                  itemSize={46}
